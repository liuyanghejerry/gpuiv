...
| Chat example threads + chrome polish | `136d4f5` `c98b414` | pending | per-thread transcripts, demo send/retry replies, history arrows, search filter, settings/inspector (~860 lines of their React chat.tsx, picker/search/focus fixes included); large hand-port over our diverged flagship — discuss before porting |
