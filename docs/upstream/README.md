...
Inventoried range: `367ef48..0fac5c9` (2026-09-13). Earlier history is in
...
| #PLACEHOLDER | Layer-shell window kind: napi `WindowOptions.layerShell` + `appId` → `WindowKind::LayerShell` (Linux/Wayland; zed already had `gpui::layer_shell`, no bump), layer surfaces open at the origin, README docs; ledger round `18e695e..0fac5c9` also declines `5388016` (website hero) into the web topic — upstream `bbaa202` |
